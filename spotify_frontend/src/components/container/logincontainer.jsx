...
function LoginContainer({children,screenname,navigateTo}) {
  ...
  return (
    <div className='flex flex-col h-full w-full bg-black'>
      ...
      <div className={`${currentSong?"h-9/10":"h-full"} flex w-full bg-black overflow-hidden`}>
        ...
        {/* navbar----------------- */}
        <Navbar image={user.image} back={navigateTo} usertype={user.role}/>
        {/* main ---------------------------- */}
            ...
            <div className='flex flex-col  p-3'>
                <div className='mb-8'>  
                  <div className='flex mt-10 mb-4'>
                    <p className=' mr-4 text-white hover:underline hover:opacity-100 opacity-50'>Legal</p>
                    <p className='text-white  mr-3 hover:underline hover:opacity-100 opacity-50'>Safety & Privacy Center</p>
                    <p className='text-white  hover:underline hover:opacity-100 opacity-50'>Privacy Policy</p>
                  </div>
                  <div className='flex mb-4'>
                    <p className='text-white  mr-4 hover:underline hover:opacity-100 opacity-50'>Cookies</p>
                    <p className='text-white mr-4 hover:underline hover:opacity-100 opacity-50'>About us</p>
                    <p className=' text-white  mr-4 hover:underline hover:opacity-100 opacity-50'> Accessibility</p>
                  </div>
                  <div className='mb-4'>
                    <p className=' text-white hover:underline hover:opacity-100 opacity-50'>&copy; 2024 Spotify AB</p>
                  </div>
                </div>
            </div>
            </div>
  ...
  const Fottertext = ({title})=>{
      return(
        <p className='text-white hover:underline hover:opacity-100 opacity-50'>{title}</p>
      )
  }
